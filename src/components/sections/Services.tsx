...
const services = [
  {
    ...
    description: "Alivia o estresse, reduz a tensão muscular, melhora o sono e promove um profundo bem-estar e alívio da ansiedade.",
    color: "bg-[#E8F3E8]",
    message: "Olá, gostaria de agendar uma Massagem Relaxante para aliviar o estresse."
  },
  {
    icon: HandHeart,
    title: "Massagem Terapêutica",
    description: "Focada na recuperação. Ajuda a aliviar dores crônicas, reduzir nódulos de tensão e acelerar a recuperação de lesões.",
    color: "bg-[#EDF6F9]",
    message: "Olá, estou com dores musculares e gostaria de agendar uma Massagem Terapêutica."
  },
  {
    icon: Stack,
    title: "Pedras Quentes",
    description: "O calor das pedras vulcânicas penetra nos músculos, reduzindo o estresse e equilibrando a energia do corpo.",
    color: "bg-[#FFF4E6]",
  ...
  },
  {
    ...
    description: "Estimula o sistema linfático, eliminando toxinas, reduzindo a retenção de líquidos e melhorando a saúde da pele.",
    color: "bg-[#FDE2E4]",
  ...
  },
  {
    ...
    description: "Estimula a regeneração celular e a circulação, hidratando profundamente e uniformizando a aparência da pele.",
    color: "bg-[#F0F4F8]",
  ...
  },
  {
    ...
    description: "Cuidado especial para mamães. Alivia dores nas costas, reduz o inchaço e promove relaxamento seguro para o bebê.",
    color: "bg-[#FFF0F5]",
    message: "Olá, sou gestante e gostaria de agendar uma massagem especializada."
  },
  {
    icon: Plant,
    title: "Bambu Terapia",
    description: "Utiliza bastões de bambu para uma massagem vigorosa que modela o corpo, alivia tensões e estimula a drenagem.",
    color: "bg-[#F5F5DC]",
  ...
  },
  {
    ...
    description: "Focada no contorno corporal e redução de celulite. Estimula o metabolismo local e melhora a firmeza da pele.",
    color: "bg-[#E6E6FA]",
    message: "Olá, gostaria de saber mais sobre a Massagem Estética modeladora."
  }
];
          ...
          {services.map((service, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-2 text-sm font-bold text-[#84A98C] opacity-0 group-hover:opacity-100 transition-opacity transform translate-y-2 group-hover:translate-y-0">
